...
export default class TreeGridLwc extends LightningElement {
    ...
    formatGridData(result){
        ...
        console.log('this.noOfRelatedAccounts*' + this.noOfRelatedAccounts)    
        if(this.gridData.length > this.noOfRelatedAccounts){
            let elemsToDelete = this.gridData.length - this.noOfRelatedAccounts;
