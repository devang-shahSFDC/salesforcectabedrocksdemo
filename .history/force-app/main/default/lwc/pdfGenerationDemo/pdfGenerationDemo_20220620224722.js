...
import TRAILHEAD_CHARACTERS from '@salesforce/resourceUrl/kerrylogo';
export default class PdfGenerationDemo extends LightningElement {
    ...
    pdfHandler(){
        ...
        generatePDF({ recordId:this.recordId, htmlData:content.outerHTML}).then(result=>{
            ...
            AddImageToTheExistingPDF.addImageToPDF(`https://democom60-dev-ed.lightning.force.com/servlet/servlet.FileDownload?file=${result.Id}`);
